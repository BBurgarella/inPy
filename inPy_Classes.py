...
class path:
    ...
    def Init3DSinus(self,LinearMatrix,Lengh,NbPoints,Omega,Phi,R0,Cth,Th0):
        """
            Équation paramétrique de la droite
            {x = Cx*t+Ax;y = Cy*t+Ay;z = Cz*t+Az}
            ...
            {r = R0*sin(x+Phi), theta = Cth*x+Th0}
        """
...
class bundle():
    def __init__(self,InitShapeFunction,PathGenerationFunction,X0 = 0, Shapeargs = [], Pathargs = [],**kwargs):
        """
    ...
    def GeneratePaths(self):
        SeedMatrix = self.ShapeFunction(*Shapeargs)
